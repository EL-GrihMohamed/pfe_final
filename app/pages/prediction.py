...
def show():
    ...
    with col_btn2:
        predict_clicked = st.button("Lancer la prédiction", width="stretch")
    ...
    if predict_clicked:
        st.session_state.form_data = input_values.copy()
        st.session_state.prediction_done = True

    if st.session_state.prediction_done and st.session_state.form_data:
        input_dict = st.session_state.form_data
